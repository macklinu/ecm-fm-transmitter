/*
 * ECM - breadboard radios
 *
 * Code for breadboard radios
 * Uses EEPROM to store frequency on each Arduino
 * No more need to update frequency each time a radio is powered on
 *
 */
...
long initialFrequency = 100100000;  // the default initial frequency in Hz
long frequency;          
long newFrequency = 0;
